	...
	<div class="contact">
		...
		<div class="footer">
			<div class="col-md-4">
				...
				<p><my-address></my-address></p>
			</div>
			<div class="col-md-4">
				<h1> <span class="icon-email"></span>EmailMe</h1>
				<p><my-email></my-email></p>
			</div>
			<div class="col-md-4">
...
<script>
  import Tel from './introduction/tel.vue'
  import Address from './introduction/address.vue'
  import Email from './introduction/email.vue'
	export default {
    components:{
      Tel,
      MyAddress:Address,
      MyEmail:Email
			...
			methods:{
				submit:function () {
						...
						if(this.count>=3){
//							this.$axios.post('/user_item',this.users).then(function (res) {
//									alert(res.data);
//									$('#form')[0].reset();
//							});
              $.ajax({
